...
/***/ function(module, exports, __webpack_require__) {
	...
	var _developerJs = __webpack_require__(2);

	var _sprintJs = __webpack_require__(3);

	jQuery(function () {
	    $.getJSON("sprint76.json").then(function (data) {
	        var spr = new _sprintJs.Sprint(data.name, data.projects, data.developers);
...
/***/ function(module, exports) {
	...
	var Developer = (function () {
	    function Developer(_ref) {
	        ...
	        var availability = _ref$availability === undefined ? 0 : _ref$availability;
	    ...
	    _createClass(Developer, [{
	        key: 'refreshSprintAvailability',
	        value: function refreshSprintAvailability() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sprint = (function () {
	    function Sprint(name) {
	        var projects = arguments.length <= 1 || arguments[1] === undefined ? [] : arguments[1];
	        var developers = arguments.length <= 2 || arguments[2] === undefined ? [] : arguments[2];
	        ...
	        try {
	            for (var _iterator = developers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                var dev = _step.value;
	    ...
	    _createClass(Sprint, [{
	        key: 'addDeveloper',
	        value: function addDeveloper(dev) {
	            var dev_obj = new _developerJs.Developer(dev);
	        ...
	        key: 'addDevelopers',
	        value: function addDevelopers() {
	            for (var _len = arguments.length, developers = Array(_len), _key = 0; _key < _len; _key++) {
	                developers[_key] = arguments[_key];
	            }

	            this.developers = [].concat(_toConsumableArray(this.developers), developers);
	        }
	    }, {
	        key: 'toString',
	        value: function toString() {
	        ...
	        value: function getTotalHours() {
	            ...
	            try {
	                for (var _iterator3 = this.developers[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	        ...
	        value: function renderTable() {
	            ...
	            jQuery(selector).jsGrid({
	                ...
	                height: "400px",
	                editing: true,
	                fields: [].concat(fields, [{ type: "control" }]),
	                data: this.developers,
	                onItemUpdated: function onItemUpdated(_ref) {
	                    var row = _ref.row;
	                    var item = _ref.item;
	                    ...
	                    _this.developers[itemIndex].refreshSprintAvailability();
	                    _this.refreshProjectsAllocation();
	                    jQuery(_this.table_selector).jsGrid("refresh");
	                    var total = _this.getTotalHours();
	        ...
	        key: 'refreshProjectsAllocation',
	        value: function refreshProjectsAllocation() {
	            var _iteratorNormalCompletion5 = true;
	            var _didIteratorError5 = false;
	            var _iteratorError5 = undefined;

	            try {
	                for (var _iterator5 = this.projects[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
	                    ...
	                    try {
	                        for (var _iterator6 = this.developers[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
	                            var dev = _step6.value;
	        ...
	        key: 'refreshProjectBlock',
	        value: function refreshProjectBlock(project) {
	            $('#project_' + project.name + ' .allocation').html('' + project.allocation);
	            if (!project.gauge) {

	                var element = document.querySelector('#project_' + project.name + ' .proj-gauge');
	        ...
	        key: 'renderProjects',
	        value: function renderProjects(selector) {
	            ...
	            try {
	                for (var _iterator7 = this.projects[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../css-loader/index.js!./jsgrid-theme.css", function() {
				var newContent = require("!!./../../css-loader/index.js!./jsgrid-theme.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports) {
	...
	module.exports = Gauge = function Gauge(container, opts) {
	    ...
	    function drawTicks() {
	        ...
	        for (key in opts.labels) {
	            if (opts.labels.hasOwnProperty(key)) {
	                ...
	                line = createElement('line', attrs, 'tick');
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../css-loader/index.js!./gauge.css", function() {
				var newContent = require("!!./../../css-loader/index.js!./gauge.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/*\r\n    CSS for gauge component\r\n    Author: Sergey Shishigin (shishigin.sergey@gmail.com)\r\n*/\r\n\r\nsvg.gauge{\r\n    width: 600px;\r\n    height: 500px;\r\n}\r\n\r\nsvg.gauge path.dial_indicator {\r\n    fill: none;\r\n    stroke-width: 5;\r\n}\r\n\r\nsvg.gauge circle.meter_needle, svg.gauge polygon.meter_needle{\r\n    fill: #1E98E4;\r\n    stroke: none;\r\n    stroke-width: 0;\r\n}\r\n\r\nsvg.gauge text.tick_label{\r\n    font-size: 12pt;\r\n    font-family: Arial, Helvetica, sans-serif;\r\n    text-anchor: middle;\r\n    dominant-baseline: central;\r\n    /*stroke: black;*/\r\n}\r\n\r\nsvg.gauge line.tick{\r\n    stroke: black;\r\n    stroke-width: 1;\r\n}", ""]);
